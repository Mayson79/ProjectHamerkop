...
namespace PH.MessengerSystem
{
    public static class Messenger
    {
        ...
        public static void Register<TMessageTarget>(TMessageTarget messageTarget) where TMessageTarget : class, IMessageTarget
        {
        ...
        public static void UnRegister<TMessageTarget>(TMessageTarget messageTarget) where TMessageTarget : class, IMessageTarget
        {
            var type = typeof(TMessageTarget);
        ...
        public static void Execute<TMessageTarget>(Action<TMessageTarget> functor) where TMessageTarget : class, IMessageTarget
        {
            var type = typeof(TMessageTarget);
            if (!targets.ContainsKey(type)) return;
